    ...
    def h2_send_fuzzy_data(self, inputdata, list_responses):
        try:
            ...
            if inputdata.string_mutated:
                #print("Host:", inputdata.host)
                #print("Port:", inputdata.port)
                #print("Host Header:", inputdata.host_header)
                #print("Seed:", inputdata.seed)
    ...
    def run_individual(self, seeds, _queue):
        ...
        for seed in seeds:
            ...
            if self.testing_mode:
                ...
                responses = self.get_responses(seed, base_input)
                responses_map[str(responses)] = str(base_input.tree_to_humanreadable_sequence())
